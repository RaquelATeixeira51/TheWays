...
public class Main {
    ...
    public static class Estrutura {
     ...
     public static class Jogador{
        ...
        public void tiraXp(int xp){
            this.xp = this.xp - xp;
        }

        public void tiraHp(int hp){
            this.hp = this.hp - hp;
        }

        public void incrementaHp(int hp){
            this.hp = this.hp + hp;
        }

        public void incrementaXp(int xp){
            this.xp = this.xp + xp;
        }
    ...
    public static class Historia {
        ...
        public static void Final() {
            ...
            Estrutura.qualquerCoisaParaContinuar();
            Estrutura.cabecalho("RESUMO JOGO");
            resumo = "Esse é o resumo do seu jogo " + jogador.getNomeJogador() + ", \nSeu personagem: " + jogador.getNome() + " \nSeu Hp e Xp: " + jogador.getHp() + " e " + jogador.getXp() + "\nSua pontuação: " + jogador.getPontuação();
